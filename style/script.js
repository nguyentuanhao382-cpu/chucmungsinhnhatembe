...
const musicBtn = document.getElementById("music-btn");
  ...
  const messages = [
    "Happy birthday chúc Em sinh nhật vui vẻ 💝🎂,tuổi mới anh chúc Em đạt được nhiều thành công thuận lợi.",
    "trong việc học và trong công việc🎉✨,luôn được yêu thương, hạnh phúc bên Gia Đình và người bên cạnh em🤗💞,",
    "em phải luôn mỉm cười nha hong được khóc trước lúc khó khăn nếu lúc em gặp khó về vấn đề nào",
    "đó thì anh mong anh sẽ luôn là người được em chia sẻ và nói ra cho anh trước anh luôn lắng nghe em, bên cạnh em đồng",
    "hành cùng em phần đời còn lại. Anh chúc em sinh nhật vui vẻ❤️🎈. ((Thùy Trang❤️))"
  ];
